...
export default function Card({ movie }) {
    ...
    return (
        ...
        <Link href={`/movie/${id}`} className="rounded-2xl w-32 sm:w-48 cursor-pointer relative group overflow-hidden border-gray-600 border hover:scale-110 transition duration-100 hover:z-10 text-center">
